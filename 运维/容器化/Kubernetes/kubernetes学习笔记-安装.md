...
docker run -itd -p 8080:80 -p 8443:443 \
    ...
    -e CATTLE_AGENT_IMAGE="registry.cn-hangzhou.aliyuncs.com/rancher/rancher-agent:v2.6.12" \
    registry.cn-hangzhou.aliyuncs.com/rancher/rancher:v2.6.12
```
## 设置镜像源
修改设置中`system-default-registry`的`registry.cn-hangzhou.aliyuncs.com`
# 补充内容
